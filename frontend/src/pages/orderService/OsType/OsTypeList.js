...
export default function OsTypeList() {
            ...
            <Row>
                <Col xl={12}>
                    <div className="text-end mt-xl-0 mt-2">
                        <Button variant="danger" className="mb-2 me-2" onClick={() => { history(`/panel/company/${2}/order-service/os-type/create`) }}>
                            <i className="mdi mdi-basket me-1" /> Novo tipo de OS
                        </Button>
                    </div>
                </Col>
            </Row>
