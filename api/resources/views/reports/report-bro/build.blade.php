...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('assets/plugins/report-bro/dist/reportbro.css') }}"/>
    <script src="{{ url('assets/plugins/report-bro/dist/ext/jquery.js') }}"></script>
    <script src="{{ url('assets/plugins/report-bro/dist/reportbro.min.js') }}"></script>
